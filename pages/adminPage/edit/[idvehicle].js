...
const EditItem = ({dataVehicle}) => {
        ...
        const handleDelete = () =>{
            ...
            axios.delete(`http://localhost:4000/v1/vehicle/${query.idVehicle}`)
            .then((res)=>{
                ...
                <div className="container">
                    <div className="row button-wrapper">
                        ...
                        <div className="col-lg-2 col-md-4">
                            {/* <button type="submit" className="btn-save">Save item</button> */}
                            <Button color="dark" onClick={handleDelete} className="delete">Delete</Button>
                        </div>
                    </div>
                </div>
                {/* </form> */}
    ...
    export const getServerSideProps = async(context) =>{
        ...
        const {data} = await axios.get(`http://localhost:4000/v1/vehicle/${idvehicle}`)
        return{
            props:{
